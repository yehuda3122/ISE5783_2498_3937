...
class CameraTest {
	...
	void testConstructRay() {
		Camera camera1 = new Camera.CameraBuilder(ZERO_POINT, new Vector(0, 0, -1), new Vector(0, -1, 0)).setVPDistance(10).setVPSize(8,8).build();
		Camera camera2 = new Camera.CameraBuilder(ZERO_POINT, new Vector(0, 0, -1), new Vector(0, -1, 0)).setVPDistance(10).setVPSize(6,6).build();
