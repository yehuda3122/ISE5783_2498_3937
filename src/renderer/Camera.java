...
public class Camera {
    ...
    private int n;
    /**
     * second parameter for number of random ray to cast for random beam anti aliasing
     */
    private int m;
    ...
    private void castRayAdaptive(int Nx, int Ny, int j, int i, int size, int depth) {
        ...
        for (var r : rayBeam) {
            Color cornerColor = rayTracerBase.traceRay(r);
    ...
    private Color constructRayAdaptiveRec(int Nx, int Ny, Point center, Ray rayToCorner, int size, int depth) {
        ...
        if (size <= depth) {
            ...
            return rayTracerBase.traceRay(rayToCorner);
        }
    }
